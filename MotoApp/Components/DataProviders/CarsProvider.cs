using MotoApp.Components.DataProviders.Extentions;
...
public class CarsProvider : ICarsProvider
{
    ...
    public List<Car> GetSpecificColunms()
    {
        var cars = _carsRepository.GetAll();
    ...
    public List<Car> WhereStartsWithAndCostsGreaterThan(string prefix, decimal cost)
    {
        var cars = _carsRepository.GetAll();
    ...
    public List<Car> TakeCarsRange(Range range)
    {
        var cars = _carsRepository.GetAll();
        return cars
            .OrderBy(x => x.Name)
